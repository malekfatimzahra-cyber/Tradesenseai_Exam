-- ============================================
-- TRADESENSE AI - SCHÉMA SQL COMPLET
-- Version: 1.0 - Full SQL Integration
-- ============================================

-- ============================================
-- 1. USERS (BASE CENTRALE) - DÉJÀ EXISTANTE
-- ============================================
-- Cette table existe déjà, référence pour les autres tables
/*
CREATE TABLE users (
...
-- ============================================
-- 3. COMMUNITY - POSTS, COMMENTS, LIKES
-- ============================================
...
-- ============================================
-- 5. CHALLENGE PLANS (OPTIONNEL - CONFIG)
-- ============================================
...
-- Seed initial plans (si table vide)
...
-- Vue pour performance optimale du leaderboard
...
-- Trigger: Incrémenter likes_count sur posts
...
-- Trigger: Décrémenter likes_count sur posts
...
-- Trigger: Incrémenter comments_count sur posts
...
-- Trigger: Décrémenter comments_count sur posts
...
-- ============================================
-- 10. SEED DATA INITIAL (OPTIONNEL)
-- ============================================

-- Créer préférences par défaut pour users existants
